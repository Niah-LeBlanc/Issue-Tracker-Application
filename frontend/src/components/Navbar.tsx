            ...
            {session && (
              <>
                ...
                <div className="hidden sm:flex sm:items-center">
                  ...
                  <Link to='#' className="text-gray-800 text-sm font-semibold border px-4 py-2 rounded-lg hover:text-purple-600 hover:border-purple-600" onClick={onLogout}>Log Out</Link>
                </div>
              </>
            )}
            ...
            <div className="block sm:hidden bg-white border-t-2 py-2">
              <div className="flex flex-col">
                ...
                <div className="flex justify-between items-center border-t-2 pt-2">
                  ...
                  <Link to="/" className="text-gray-800 text-sm font-semibold border px-4 py-1 rounded-lg hover:text-purple-600 hover:border-purple-600" onClick={onLogout}>Log Out</Link>
                </div>
              </div>
            </div>
          )}
